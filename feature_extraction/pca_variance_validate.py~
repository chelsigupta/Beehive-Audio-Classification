...
filename = 'saved_models/PCA_Variance.pkl'
...
def KNN_validation_procedure(X_test, Y_test):
    ...
    filename = 'saved_models/PCA_Variance_KNN.pkl'
...
def RF_validation_procedure(X_test, Y_test):
    ...
    filename = 'saved_models/PCA_Variance_RF.pkl'
    model = pickle.load(open(filename, 'rb'))
...
def LR_validation_procedure(X_test, Y_test):
    ...
    filename = 'saved_models/PCA_Variance_LR.pkl'
    model = pickle.load(open(filename, 'rb'))
...
def OVR_SVM_validation_procedure(X_test, Y_test):
    ...
    filename = 'saved_models/PCA_Variance_SVM.pkl'
    model = pickle.load(open(filename, 'rb'))
